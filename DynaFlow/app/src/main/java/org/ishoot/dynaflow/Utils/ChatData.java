...
// This is taken from the example Chatbot app by Softbank
...
public class ChatData {
    ...
    public void setDynamicConcept(String qiVar, List<Phrase> phraseList) {
        EditablePhraseSet editablePhraseSet = qiChatbot.dynamicConcept(qiVar);
        editablePhraseSet.async().addPhrases(phraseList);
    }

    public EditablePhraseSet getDynamicConcept(String qiVar) {
        return qiChatbot.dynamicConcept(qiVar);
    }

    public void setQiChatVariable(String qiVar, String value) {
        QiChatVariable variable = qiChatbot.variable(qiVar);
        variable.async().setValue(value);
    }

    public String getQiChatVariable(String qiVar) {
        return qiChatbot.variable(qiVar).getValue();
    }
