...
public class LocalizeAndMapHelper {
    ...
    private final String currentExplorationMapData;
    private StreamableBuffer streamableExplorationMap;
    private final List<onStartedLocalizingListener> startedLocalizingListeners;
    private final List<onFinishedLocalizingListener> finishedLocalizingListeners;
    private final List<onStartedMappingListener> startedMappingListeners;
    private final List<onFinishedMappingListener> finishedMappingListeners;
    ...
    public Future<ExplorationMap> buildStreamableExplorationMap() {
        if (explorationMap == null) {
            ...
            ExplorationMapBuilder.with(qiContext).withStreamableBuffer(streamableExplorationMap).buildAsync();
        }
        return Future.of(explorationMap);
    }

    public void preBuildStreamableExplorationMap() {
        explorationMap = ExplorationMapBuilder.with(qiContext).withStreamableBuffer(streamableExplorationMap).build();
    }
