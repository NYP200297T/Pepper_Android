...
import com.example.uitester.Fragments.GoToFrameFragment;
import com.example.uitester.Fragments.HelloFragment;
import com.example.uitester.Fragments.SplashFragment;
import com.example.uitester.Fragments.TextViewFragment;
    ...
    public void runWith(List<String> params) {
        ...
        switch (fragmentName) {
            case ("frag_hello"):
                ...
                break;
            case ("frag_goto"):
                fragment = new GoToFrameFragment();
                break;
            case ("frag_introself"):
